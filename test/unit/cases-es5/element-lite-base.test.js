...
suite('ElementLiteBase Mixin', function () {
   ...
   */
  test('defualt value is set using the attribute `value` in props', function () {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
   ...
   */
  test('observer method is called if the value of the prop has changed and should also get old data', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop4 = 'd';
    setTimeout(function () {
  ...
  test('observer method in the observers list is called if the value of the props have changed', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop5 = {
      attr1: 'e'
  ...
  test('setting value on a path works', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop5 = {
      attr1: 'g'
  ...
  test('setting value on a path works and results in _propertiesChanged', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop5 = {
      attr1: 'g'
  ...
  test('observer method in the observers list is called twice if the value of the props have changed using set', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop5 = {
      attr1: 'h'
  ...
  test('array push mutations work and _propertiesChanged are called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('array pop mutations work and _propertiesChanged are called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('array unshift mutations work and _propertiesChanged are called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('array shift mutations work and _propertiesChanged are called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('array splice (remove only) mutations work and _propertiesChanged are called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('array splice (with insert only) mutations work and _propertiesChanged are called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('array splice (with insert and remove) mutations work and _propertiesChanged are called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('array push mutations work and observer called', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop7 = ['a', 'b', 'c'];
    setTimeout(function () {
  ...
  test('readOnly should not be set and should throw an error', function () {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    expect(el.prop8).to.equal('j');
    var bad = function () { el.prop8 = 'k'; };
    expect(bad).to.throw();
    document.body.removeChild(el);
  });
  ...
  test('reflectToAttribute should reflect to attribute', function (done) {
    var el = document.createElement('test-element');
    document.body.appendChild(el);
    el.prop9 = 'k';
    setTimeout(function () {
