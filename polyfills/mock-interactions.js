(function (global, factory) {
  ...
  */
  ...
  subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
  */
  let caseMap$1 = caseMap$0; // Save map of native properties; this forms a blacklist or properties
  ...
  */
  ...
  const CaseMap = caseMap$0; // Monotonically increasing unique ID used for de-duping effects triggered
      ...
      static get importPath() {
        if (!this.hasOwnProperty(JSCompiler_renameProperty('_importPath', this))) {
          ...
          if (meta) {
            ...
            const module = DomModule && DomModule.import(
            /** @type {PolymerElementConstructor} */
            this.is);
    ...
    class LegacyElement extends legacyElementBase {
      ...
      */
      ...
      get domHost() {
        ...
        return root$$1 instanceof DocumentFragment ?
        /** @type {ShadowRoot} */
        root$$1.host : root$$1;
      }
      /**
  ...
  */
  ...
  function makeMouseEvent(type, xy, node) {
    ...
    if (HAS_NEW_MOUSE) {
      ...
      e.initMouseEvent(type, props.bubbles, props.cancelable, null,
      /* view */
      null,
      /* detail */
      0,
      ...
      0,
      /* screenY */
      props.clientX, props.clientY, false,
      /*ctrlKey */
      false,
      /*altKey */
      false,
  ...
  exports.middleOfNode = middleOfNode;
  exports.topLeftOfNode = topLeftOfNode;
  exports.makeTouches = makeTouches;
  exports.makeSoloTouchEvent = makeSoloTouchEvent;
  exports.makeMouseEvent = makeMouseEvent;
  exports.move = move;
  exports.track = track;
  exports.down = down;
  exports.up = up;
  ...
  exports.focus = focus;
  exports.blur = blur;
  exports.keyboardEventFor = keyboardEventFor;
  exports.keyEventOn = keyEventOn;
  exports.keyDownOn = keyDownOn;
  exports.keyUpOn = keyUpOn;
  exports.pressAndReleaseKeyOn = pressAndReleaseKeyOn;
  exports.pressEnter = pressEnter;
  exports.pressSpace = pressSpace;
